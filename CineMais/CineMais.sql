...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/08/2024 às 14:47
...
INSERT INTO `ingressos` (`ID Ingresso`, `Nome da Pessoa`, `Telefone`, `ID Sessao`, `ID Filme`, `Valor`) VALUES
(10, 'Pedro', '64992145744', 12, 1, 0),
(11, 'Liandro', '64992145744', 12, 1, 0),
(12, 'Pedro', '64992145744', 12, 1, 0),
(13, 'cupreto', '64992145744', 12, 1, 0);
...
INSERT INTO `sessoes` (`ID Sessao`, `Sala`, `Numero Poltronas`, `Horario`, `ID Filme`) VALUES
(12, 1, 40, '18h00', 1),
(13, 1, 0, '19h00', 2);
...
--
ALTER TABLE `ingressos`
  MODIFY `ID Ingresso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `sessoes`
  MODIFY `ID Sessao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
