...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/08/2024 às 08:00
...
INSERT INTO `ingressos` (`ID Ingresso`, `Nome da Pessoa`, `Telefone`, `ID Sessao`, `ID Filme`, `Valor`, `Produtos Comprados`) VALUES
(22, 'pedro', '1', 21, 1, 47, 'R$ 35,00 - Ingresso\n\nR$ 5,00 - Coca-Cola\n\nR$ 7,00 - Milkshake de Chocolate');
...
--
ALTER TABLE `ingressos`
  MODIFY `ID Ingresso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `sessoes`
  MODIFY `ID Sessao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
